...
# Alembic stores this in a ConfigParser, which reads "%" as interpolation
# syntax and raises on a percent-encoded password. Doubling them is the
# documented escape; ConfigParser turns "%%" back into "%" on read.
